...
INSERT INTO `fide_carrito_tb` VALUES (17,1,'110010204',3,'2025-08-19 00:27:30');
...
INSERT INTO `fide_inventario_tb` VALUES (1,'110010204',0,0,0,10,1),(2,'110010204',0,0,0,5,1),(3,'110010204',7,0,0,1,1),(4,'110010205',0,0,0,1,1),(5,'110010205',0,0,0,3,1),(6,'110010206',0,0,0,1,1);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `EliminarDelCarrito` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `EliminarDelCarrito`(
  IN p_id_usuario BIGINT,
  IN p_codigo_producto VARCHAR(20)
)
BEGIN
  ...
  SELECT IF(ROW_COUNT() > 0, 'OK', 'NOOP') AS ESTADO;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2025-08-19  0:45:27
