      ...
      <div class="about__container">
        ...
        <div class="about__info">
          ...
          <p class="about__text">
            ...
            Nuestra historia se construye con empatía, vocación de servicio y el deseo constante de cuidar tu salud día
            a día.
          </p>
          <p class="about__text">
        ...
        <div class="menu__content">
          <div class="card">
            ...
            <div class="menu__info">
              ...
              <p class="card__text">
                La acetaminofén, también conocido como paracetamol, es un medicamento ampliamente utilizado por sus
        ...
        <div class="Enfermedades__content">
          <article class="entry">
            ...
            <div class="entry__info">
              ...
              <p class="entry__description">
                Virus de la gripe: Es un virus ARN, como el del COVID-19, el SIDA, el Ébola o la hepatitis C. Tiene su
                genoma dividido en 8 fragmentos, lo que aumenta su capacidad de mutación. La gripe aviar es una
                enfermedad respiratoria que generalmente afecta a las aves. La variante D1 fue identificada por primera
                vez en el sudeste asiático en 1996 y ha sido responsable de la epidemia más grave registrada, afectando
                a poblaciones de aves en todo el mundo.
              </p>
          ...
          <article class="entry">
            ...
            <div class="entry__info">
              ...
              <p class="entry__description">
                La COVID-19 surgió de repente, se propagó rápidamente y mató a millones de personas en todo el mundo.
                Desde entonces,
                es justo decir que la mayoría de la gente se ha puesto nerviosa ante la aparición de la próxima gran
                enfermedad infecciosa,
                ya sea un virus, una bacteria, un hongo o un parásito.
              </p>
              <a href="#" class="entry__btn">Continua leyendo...
                <i class="fa-solid fa-book-open-reader"></i></a>
            </div>
          </article>
          <!-- blog entry-->
          <article class="entry">
            <div class="entry__img-container">
              <img src="../assets/Imagenes/fiebre.jpg" alt="Imagen de desayuno saludable" class="entry__image" />
            </div>
            <div class="entry__info">
              <p class="entry__date">Junio 1, 2025</p>
              <h3 class="entry__title">
              ...
              <p class="entry__description">
                ...
                (OPS) ha emitido una nueva alerta epidemiológica debido al incremento de casos de fiebre amarilla en las
                Américas
                durante los primeros meses de 2025. El número de casos humanos confirmados hasta el 22 de marzo ha más
                que duplicado
                el total registrado en todo 2024, lo que genera preocupación por una posible expansión de la enfermedad.
                En los primeros casi tres meses de 2025, se han confirmado 131 casos humanos, con 53 fallecimientos. En
                comparación, en todo
                el 2024 se reportaron 61 casos, de los cuales 30 fueron fatales. Los casos se reportaron en Bolivia (1
                caso, 1 fallecimiento),
                Brasil (81 casos, 31 fatales), Colombia (31 casos, 13 fallecimientos) y Perú (18 casos, 8 fatales), con
                casos notificados fuera de la región
